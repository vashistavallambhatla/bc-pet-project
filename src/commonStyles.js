...
const profilePageCards = {textTransform : "uppercase",maxWidth : "700px",alignItems : "center",borderRadius : "10px",padding : "30px 50px",backgroundColor : white,marginTop : "50px",display : "flex",flexDirection : "column",gap : "1rem"}
